...
if __name__ == '__main__':
    ...
    # netglob = torch.load("/home/zikaixiao/zikai/aaFL/fl_gba_cifar100/output/if100/netglob_286.pth", map_location='cpu')
    ...
    for rnd in tqdm(range(args.rounds)):
        ...
        # torch.save(netglob, "./output/if100/" + "netglob_" + str(rnd) + ".pth")

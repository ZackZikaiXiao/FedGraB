...
def FedAvg_Integrate(backbone_w_locals, linear_w_locals_1, linear_w_locals_2, dict_len):
    backbone_w_avg = FedAvg_noniid(backbone_w_locals, dict_len)
    linear_w_avg_1 = FedAvg_noniid(linear_w_locals_1, dict_len)
    linear_w_avg_2 = FedAvg_noniid(linear_w_locals_2, dict_len)
    return backbone_w_avg, linear_w_avg_1, linear_w_avg_2
